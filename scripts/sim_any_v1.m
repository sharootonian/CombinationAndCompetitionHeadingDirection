function sub = sim_any_v1(model_flag, X, fb_flag, target, feedback, headAngle_feedback)


sub.model_flag  = model_flag;
sub.FB          = fb_flag;
sub.fb          = feedback;
sub.fb_true     = headAngle_feedback;
sub.target      = target;
sub.X_sim       = X; % keep track of simulation parameters for parameter recovery
